<?php
if(!class_exists('Ajax_Tdl_Instagram_Setting_Admin')){
	class Ajax_Tdl_Instagram_Setting_Admin{
		public static $_instance = null;
		public static $url_id    = 'https://smashballoon.com/instagram-feed/find-instagram-user-id/';
		public static $url_token = 'http://instagram.pixelunion.net/';
		...
		public function __construct(){
			$this->settings_group = 'ajax_tdl_instagram_setting';
			add_action( 'admin_init', array( $this, 'ajax_pagination_register_settings' ));
			add_action( 'admin_menu', array( $this, 'sub_menu_page_init' ));
		}
		public function init_ajax_tdl_instagram_setting(){
			$this->settings = apply_filters( 'ajax_tdl_instagram_settings',
				array(
					'ajax_tdl_instagram_ok' => array(
						__( 'General Ajax Instagram(copy shortcode [ajp_tdl_instagram] paste to page, post)', 'ajp' ),
						array(
							array(
								'name'        => 'tdl_title',
								'label'      => __( 'Title', 'ajp' ),
								'desc'       => __( 'Input Title', 'ajp'),
								'type'       => 'text',
								'std'        => 'Instagram',
							),
							array(
							...
							array(
								'name'        => 'tdl_user_id',
								'label'      => __( 'Instagram user ID (<a href="https://smashballoon.com/instagram-feed/find-instagram-user-id/" target="_blank">Lookup your User ID</a>)', 'ajp' ),
								'desc'       => __( 'Input user ID', 'ajp'),
								'type'       => 'text',
								'std'        => 'abc',
							),
							array(
								'name'        => 'tdl_token',
								'label'      => __( 'Instagram Access Token (<a href="http://instagram.pixelunion.net/" target="_blank">Lookup your Access Token</a>)', 'ajp' ),
								'desc'       => __( 'Input user ID', 'ajp'),
								'type'       => 'text',
								'std'        => 'abc',
							),
		...
		public function ajax_pagination_register_settings(){
			$this->init_ajax_tdl_instagram_setting();
		...
		public function sub_menu_page_init() {
			add_menu_page(
				...
				, 'manage_options'
				, 'plugin_settings'
				, array($this, 'ajax_tdl_instagram_settings_render')
				, null
				, null
			);
		}
		public function ajax_tdl_instagram_settings_render() { 
		?>
...
Ajax_Tdl_Instagram_Setting_Admin::instance();